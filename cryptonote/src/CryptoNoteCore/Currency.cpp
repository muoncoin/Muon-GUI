...
namespace CryptoNote {
	...
	bool Currency::checkProofOfWorkV2(Crypto::cn_context& context, const Block& block, difficulty_type currentDiffic,
		...
		if (8 * sizeof(m_genesisBlockHash) < block.parentBlock.blockchaiMUOanch.size()) {
			return false;
		}
		...
		Crypto::tree_hash_from_branch(block.parentBlock.blockchaiMUOanch.data(), block.parentBlock.blockchaiMUOanch.size(),
