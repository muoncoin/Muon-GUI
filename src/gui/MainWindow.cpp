...
// Copyright (c) 2016-2017 - 2018 Muon developers - Derived work from -Karbowanec-
...
void MainWindow::initUi() {
  setWindowTitle(QString(tr("Muon Wallet %1")).arg(Settings::instance().getVersion()));
#ifdef Q_OS_WIN32
  createTrayIcon();
#endif
...
void MainWindow::createTrayIcon()
{
    ...
    QString toolTip = QString(tr("Muon Wallet %1")).arg(Settings::instance().getVersion());
